...
@@ -151,6 +146,7 @@ unsigned char * stage = NULL;	/* hexdump
...
+USHORT o_allowbroad = 0;
 ...
 USHORT o_listen = 0;
 USHORT o_nflag = 0;
@@ -160,6 +156,7 @@ USHORT o_udpmode = 0;
 USHORT o_verbose = 0;
...
+
 ...
 void tmtravel ()
 {
@@ -333,6 +338,7 @@ HINF * gethostpoop (name, numeric)
...
@@ -361,9 +367,9 @@ HINF * gethostpoop (name, numeric)
...
+#endif
   ...
   if (rr == -1)
@@ -1216,6 +1229,18 @@ Debug (("got %d from the net, errno %d",
...
@@ -1389,12 +1411,14 @@ main (argc, argv)
